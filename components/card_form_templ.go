...
func cardForm() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		_, err = templBuffer.WriteString("<form class=\"flex flex-col gap-4\" hx-post=\"/cards\" hx-target=\"#cards-list\" hx-swap=\"beforeend\"><textarea class=\"textarea textarea-primary\" name=\"front\" placeholder=\"Front\"></textarea><textarea class=\"textarea textarea-primary\" name=\"back\" placeholder=\"Back\"></textarea><div><button type=\"submit\" class=\"btn\">")
		if err != nil {
			return err
		}
		var_2 := `Add`
